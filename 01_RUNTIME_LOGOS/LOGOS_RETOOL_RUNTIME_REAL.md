...
- distinzione chiara tra parser, normalization base, duration normalization, type classification, preview e save flow  
...
non bloccante per insert/update/type classification.
